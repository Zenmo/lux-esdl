...
fun DependencyHandlerScope.addLuxDependencies() {
    ...
    val anylogicProjectNames = parsedAlpxFiles.map { alpxFile ->
        xpath.evaluate("//AnyLogicWorkspace/Model/Name/text()", alpxFile)
    }
    ...
    val anlogicWorkspace = "/home/erik/.AnyLogicPLE/Workspace8.8"
    anylogicProjectNames.forEach { project ->
        implementation(files("${anlogicWorkspace}/${project}_BUILD/classes"))
    }
