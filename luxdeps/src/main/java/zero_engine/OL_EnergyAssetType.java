...
public enum OL_EnergyAssetType {
  ...
  HEAT_DELIVERY_SET, METHANE_FURNACE, HYDROGEN_FURNACE, ELECTRIC_HEATER, ELECTROLYSER, HYDROGEN_DEMAND, ELECTRIC_HOB, RESIDUALHEATHT, RESIDUALHEATLT, METHANE_CHP, GAS_HOB, 
