...
public enum OL_VehicleType {
   ...
   */
  public static OL_VehicleType random( Agent agent ) {
    return agent.randomFrom( OL_VehicleType.class );
  }
   ...
   * @return the randomly chosen option list item
   */
  public static OL_VehicleType random( Experiment<?> experiment ) {
    return experiment.randomFrom( OL_VehicleType.class );
  }
   ...
   * @return the randomly chosen option list item
   */
  public static OL_VehicleType random( Random r ) {
    return Utilities.randomFrom( OL_VehicleType.class, r );
  }
}
