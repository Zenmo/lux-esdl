...
public enum OL_GISObjectType {
  REGION, NEIGHBOURHOOD, PARCEL, BUILDING, GRIDNODE, CHARGER, SOLARFARM, WINDFARM, BATTERY, ELECTROLYSER, DIESEL_GEN, 
  ANTI_LAYER, LV_CABLE, MV_CABLE, REMAINING_BUILDING, GN_SERVICE_AREA, OTHER, COOP, PARKING;
