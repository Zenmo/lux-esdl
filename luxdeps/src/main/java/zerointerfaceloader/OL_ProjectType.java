...
public enum OL_ProjectType {
  BUSINESSPARK, RESIDENTIAL;
   ...
   */
  public static OL_ProjectType random( Agent agent ) {
    return agent.randomFrom( OL_ProjectType.class );
  }
   ...
   * @return the randomly chosen option list item
   */
  public static OL_ProjectType random( Experiment<?> experiment ) {
    return experiment.randomFrom( OL_ProjectType.class );
  }
   ...
   * @return the randomly chosen option list item
   */
  public static OL_ProjectType random( Random r ) {
    return Utilities.randomFrom( OL_ProjectType.class, r );
  }
}
